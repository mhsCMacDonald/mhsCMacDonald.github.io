...
Created by Charlie MacDonald on May 3rd, 2019. Finished on May 7th, 2019.

This code will allow the user to play a simple multiple choice game. Press enter
to restart and follow the printed text instructions to answer the questions. The
program will notify the user of how many they got right or wrong.*/

//Create a level for the instructions page, the questions, and the win/loss page.
  let level = 0

//Create variables that keep track of the # correct or incorrect.
  let correct=0;
  let incorrect=0;
