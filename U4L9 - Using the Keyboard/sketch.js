...
Created by Charlie MacDonald on apr 29th, 2019*/
...
I placed this "if" statement first since the program must always check if the players
...
//If nobody has won, and the mouse hasn't been pressed to restart the game, play the game normally:
  ...
  //draw a background over the previous old rectangles
    ...
    //create a varibale that is true when the two rectangles collide:
