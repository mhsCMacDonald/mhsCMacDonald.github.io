/* U4L6 - Face Assignment
Created on March 25th, 2019. Finished on April 5th, 2019.
Group members: Abdol, Charlie, Matt, and Tina.
I (Charlie) cleaned up this sketch.js file - The code is functionally the same as the
rest of my group's code, but I tidied up the documentation.*/

//This code will draw a simple fictional face.

//Notes and tips for group members:
...
//Variables to allow for easy scaling.
let Facewidth = 100;
let Faceheight = 150;
...
//Call all the functions needed to draw the face:
function draw() {
  drawEars();
  drawFace();
  drawNose();
...
//This function (glasses and frame) by Charlie
  stroke(169,169,169);
  ...
  fill(161,202,241,200); //lens colour - 4th number adjusts transparency
  rectMode(CENTER);
  rect(newX,newY,Facewidth*1.5,Faceheight/1.5, 15, 15, 15, 15); //glass lenses - the last 4 numbers make them round
...
function drawFace(){
//This function by Charlie. Draws the head, and has the ability to scale. @Charlie
  fill(255,224,189);
  stroke(230,202,171);
  fill(230,202,171);
